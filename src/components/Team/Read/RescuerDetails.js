...
class RescuerDetails extends Component {
  ...
  componentDidMount() {
    ...
    const { id, name, surname, branch, minePosition, KSRGPosition, doctor, trainingGroup, duty, included, suspend } = rescuer;
    this.setState({
      id,
      name,
      surname,
  ...
  handleSubmit = () => {
    ...
    const { id, name, surname, branch, minePosition, KSRGPosition, doctor, trainingGroup, duty, included, suspend, redirect } = this.state;
    const updatedRescuer = { id, name, surname, branch, minePosition, KSRGPosition, doctor, trainingGroup, duty, included, suspend };
