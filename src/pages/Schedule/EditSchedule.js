...
const EditSchedule = ({ editId, schedule, handleChange }) => {

  let editSchedule = schedule.filter(week => week.id === editId)
  let week = editSchedule[0]
  ...
  return (
    <>
      ...
      <h1><u>Tryb edycji</u> harmonogramu na okres {week.dateFrom} - {week.dateTo}</h1>
      <div className="table">
        {day(
          'Monday', 'Poniedziałek',
